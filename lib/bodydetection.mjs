...
const bodyPart2DNames = () => Object.values(bodyParts2D)
const bodyPart3DNames = () => Object.values(bodyParts3D)
...
function * bodiesToObjectsGenerator(bodies) {
        for (let i = 0; i < bodies.length; i++)
            yield {
                bodyIndex: i,
                bodyPartsData: bodies[i].toObject()
            }
    }

export { detectBodies, Body, BodyPart2D, bodyParts2D, bodyParts3D, bodyPart2DNames, bodyPart3DNames, bodiesToObjectsGenerator }